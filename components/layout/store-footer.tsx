...
export function StoreFooter({ storeName, socialInstagram, socialTiktok, socialFacebook, socialWhatsapp }: StoreFooterProps) {
  const hasSocial = socialInstagram || socialTiktok || socialFacebook || socialWhatsapp
  return (
      ...
      <div className="mx-auto max-w-2xl space-y-3 px-4 text-center text-sm" style={{ color: "var(--store-text)", opacity: 0.6 }}>
        {hasSocial && (
          <div className="flex items-center justify-center gap-4">
            ...
            {socialWhatsapp && (
              <a href={socialWhatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
